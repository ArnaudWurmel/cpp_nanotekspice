...
// Last update Tue Feb 28 12:10:00 2017 Arnaud WURMEL
//
...
nts::c4081::c4081(const std::string &value) : _links(0)
{
  (void)value;
}

bool	nts::c4081::getValueForPin(size_t pin)
{
...
bool	nts::c4081::alreadyLink(size_t pin)
{
  std::vector<std::pair<size_t, std::pair<size_t, IComponent *> > >::iterator	it;
