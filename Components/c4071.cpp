...
// Last update Tue Feb 28 13:15:12 2017 Arnaud WURMEL
//
...
nts::c4071::c4071(const std::string &value) : _links(0)
{
  (void)value;
}

bool	nts::c4071::getValueForPin(size_t pin)
{
...
bool	nts::c4071::alreadyLink(size_t pin)
{
  std::vector<std::pair<size_t, std::pair<size_t, IComponent *> > >::iterator	it;
